...
public class PdfFontUtil {
    ...
    public static final String FONT = "D:\\Desktop\\demo\\demo\\src\\main\\resources\\static\\猫啃什锦黑.ttf";

    /**
     * 基础样式
     */
    public static final Font TITLE_FONT = FontFactory.getFont(FONT, BaseFont.IDENTITY_H, 30, Font.BOLD);
    public static final Font NODE_FONT = FontFactory.getFont(FONT, BaseFont.IDENTITY_H, 20, Font.NORMAL);
    public static final Font BLOCK_FONT = FontFactory.getFont(FONT, BaseFont.IDENTITY_H, 18, Font.NORMAL, BaseColor.BLACK);
    public static final Font INFO_FONT = FontFactory.getFont(FONT, BaseFont.IDENTITY_H, 17, Font.NORMAL, BaseColor.BLACK);
